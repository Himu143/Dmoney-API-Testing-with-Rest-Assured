...
public class User extends Setup {
    ...
    public void callLoginAPIWithInvalidEmail() {
        UserModel loginModel = new UserModel("wrong@roadtocareer.net", "1234");
    ...
    public void callLoginAPIWithInvalidPassword() {
        UserModel loginModel = new UserModel("salman@roadtocareer.net", "433424");
    ...
    public void callLoginAPIWithValidCreds() throws ConfigurationException {
        RestAssured.baseURI = prop.getProperty("base_url");
        Response res =
                given()
                        .contentType("application/json")
    ...
    public void createUserExistingInfo() {

        UserModel regModel = new UserModel("Giuseppe Rowe", "1234", "cecile.schuppe@hotmail.com", "01700638119", "1100154448", "Customer");
        RestAssured.baseURI = prop.getProperty("base_url");
        Response res =
                given()
                        .contentType("application/json")
    ...
    public void createNewUser() throws ConfigurationException {
        Utils utils = new Utils();
        utils.generateRandomUser();
        UserModel regModel = new UserModel(utils.getName(), "1234", utils.getEmail(), utils.generatePhoneNumber(), "1100154448", "Customer");
        RestAssured.baseURI = prop.getProperty("base_url");
        Response res =
                given()
                        .contentType("application/json")
    ...
    public void createAgent() throws ConfigurationException {
        Utils utils = new Utils();
        utils.generateRandomUser();
        UserModel regModel = new UserModel(utils.getName(), "1234", utils.getEmail(), utils.generatePhoneNumber(), "1100154448", "Agent");
        RestAssured.baseURI = prop.getProperty("base_url");
        Response res =
                given()
                        .contentType("application/json")
    ...
    public void searchUserByInvalidPhonenumber() throws ConfigurationException, IOException {
        ...
        Response res =
                given()
                        ...
                        .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                        .when()
                        .get("/user/search/phonenumber/01583169342");
